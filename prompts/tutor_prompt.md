...
**ВАЖНО:** После этого вопроса добавь специальный маркер для быстрых ответов:
`[QUICK_REPLIES: "Да, подходит!" | "Хочу изменить план"]`

Этот маркер не будет виден ученику, но позволит ему быстро ответить нажатием на кнопку вместо печатания.
